    ...
    methods: {
        fetchBooks: function () {
            ...
            fetch(`${apiURL}Books/Basic`)
                ...
                .catch(err => console.error('Fout: FetchBooks ' + err));
        },
        fetchBookDetails: function (book) {
            ...
            fetch(`${apiURL}Books/${book.id}`)
                ...
                .catch(err => console.error('Fout: FecthBookDetails ' + err));
        },
        ...
        fetchAuthors: function () {
            ...
            fetch(`${apiURL}Authors`)
                ...
                .catch(err => console.error('Fout: fetchAuthors ' + err));
        },
        fetchPublishers: function () {
            ...
            fetch(`${apiURL}Publishers`)
                ...
                .catch(err => console.error('Fout: fetchPublishers ' + err));
        },
        ...
        save: function () {
            ...
            if (self.isEdit) {
                ...
                fetch(myRequest)
                    ...
                    .catch(err => console.error('Fout: books/ajaxconfig ' + err));
            }
            self.isEdit = false;
        ...
        deleteBook: function () {
            ...
            fetch(`${apiURL}Books/${self.currentBook.id}`, { method: 'DELETE' })
                ...
                .catch(err => console.error('Fout: Deletebook ' + err));
        }
    }
});